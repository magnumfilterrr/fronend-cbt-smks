...
class SoalResponseModel {
    ...
    factory SoalResponseModel.fromRawJson(String str) => SoalResponseModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory SoalResponseModel.fromJson(Map<String, dynamic> json) => SoalResponseModel(
        status: json["status"],
...
class Soal {
    ...
    Soal({
        ...
        required this.gambarPertanyaan,
...
class PilihanJawaban {
    ...
    factory PilihanJawaban.fromRawJson(String str) => PilihanJawaban.fromJson(json.decode(str));
